...
$create_db_sql = "CREATE DATABASE IF NOT EXISTS `" . $mysqli->real_escape_string($db_name) . "` 
...
if ($check_stmt->num_rows > 0) {
    $check_stmt->close();
    $mysqli->close();
    // Redirect back to registration page with error flag
...
$insert_sql = "INSERT INTO users 
    (id_number, last_name, first_name, middle_name, course, year_level, email, password, address) 
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
